...
let project = Project(name: "kDrive",
                      packages: [
                          ...
                          .package(url: "https://github.com/Infomaniak/ios-core", .upToNextMajor(from: "3.1.0")),
                          ...
                          .package(url: "https://github.com/Infomaniak/ios-dependency-injection", .upToNextMajor(from: "1.1.8")),
