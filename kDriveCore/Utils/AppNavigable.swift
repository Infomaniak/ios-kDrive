...
public protocol RouterAppNavigable {
    ...
    @MainActor func showSearch(query: String?)
...
public protocol RouterFileNavigable {
    ...
    @MainActor func presentPublicShareLocked(_ link: PublicShareLink)
    ...
    /// Present a single file public share, regardless of authenticated state
    @MainActor func presentPublicShare(
