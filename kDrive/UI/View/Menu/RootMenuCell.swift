...
class RootMenuCell: UICollectionViewCell {
    ...
    override var isSelected: Bool {
        didSet {
            contentInsetView.backgroundColor = isSelected ?
                InfomaniakCoreAsset.backgroundCardViewSelected.color : InfomaniakCoreAsset.backgroundCardView.color
        }
    }
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            contentInsetView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 24),
            contentInsetView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 24),
            contentInsetView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -24),
            topConstraint!,
            bottomConstraint!,
