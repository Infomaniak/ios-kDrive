...
class SelectView: UIView {
    ...
    override func awakeFromNib() {
        ...
        moveButton.accessibilityLabel = KDriveStrings.Localizable.buttonMove
        deleteButton.accessibilityLabel = KDriveStrings.Localizable.buttonDelete
        moreButton.accessibilityLabel = KDriveStrings.Localizable.buttonMenu
    }

    func updateTitle(_ count: Int) {
        titleLabel.text = KDriveStrings.Localizable.fileListMultiSelectedTitle(count)
    }
