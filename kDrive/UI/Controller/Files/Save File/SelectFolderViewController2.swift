...
class SelectFolderViewController2: FileListViewController {
    ...
    @IBAction func selectButtonPressed(_ sender: UIButton) {
        ...
        if navigationController?.viewControllers.first is SelectFolderViewController2 {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if selectedFile.isDirectory {
            let nextVC = SelectFolderViewController2.instantiate(driveFileManager: driveFileManager)
