...
public struct AppRouter: AppNavigable {
    ...
    @MainActor public func presentUpSaleSheet() {
        ...
        rootViewController.dismiss(animated: true) {
            let myKSuiteViewController = UIHostingController(rootView: MyKSuiteView(configuration: .kDrive))
    ...
    @MainActor private func presentAnyPublicShare(
        ...
        rootViewController.dismiss(animated: false) {
            let publicShareViewModel = publicShareViewModel(frozenRootFolder: frozenRootFolder,
                                                            singleFrozenFile: singleFrozenFile,
                                                            publicShareProxy: publicShareProxy,
                                                            driveFileManager: driveFileManager,
                                                            apiFetcher: apiFetcher)
    ...
    @MainActor private func publicShareViewModel(frozenRootFolder: File,
                                                 singleFrozenFile: File?,
                                                 publicShareProxy: PublicShareProxy,
                                                 driveFileManager: DriveFileManager,
